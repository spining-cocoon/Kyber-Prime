...
#define GEN_MATRIX_NBLOCKS ((12*KYBER_N*(1 << 12)/(8*q) + XOF_BLOCKBYTES)/XOF_BLOCKBYTES)
...
#define polyvec_matrix_mul KYBER_NAMESPACE(polyvec_matrix_mul)
...
#define polyvec_mul KYBER_NAMESPACE(polyvec_mul)
